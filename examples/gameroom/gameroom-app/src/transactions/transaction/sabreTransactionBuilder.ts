...
import { Transaction, TransactionHeader, ExecuteContractAction, SabrePayload } from '../../tprotos/compiled_protos';
...
export class SabreTransactionBuilder extends TransactionBuilder {
  ...
  build(signer: Signer): Transaction {
    ...
    const sabrePayload = SabrePayload
      .encode({
    ...
    const sabreTransactionHeader = TransactionHeader.encode({
      ...
      familyVersion: this.sabreVersion,
